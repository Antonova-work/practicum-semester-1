...
def straf(field): #для подсчёта штрафных очков. Принимает на вход поле field.
    r = [0, 0, 0]
    #Инициализация списка r для хранения штрафных очков трёх игроков. Индекс 0 соответствует игроку 1, индекс 1 — игроку 2, индекс 2 — игроку 3.
