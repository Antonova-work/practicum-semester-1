...
играть в «Максит» (правила). Правила игры следующие. В клетках квадрата
...
победителя. Сама программа
с целью выиграть игру.
'''
...
while True: 
    ...
    if not moves:#если ходов нет у текущего игрока
        ...
        continue
    #continue: если ходов нет у обоих игроков, игра завершается (break выходит из цикла) 
